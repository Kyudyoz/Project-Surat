    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h4 style="text-decoration: underline" class="fs-2 mt-4">Surat Keterangan Domisili</h4>
            </div>
        </div>
        <div class="row">
        ...
        <div class="keterangan">      
            <p class="mt-4">Adalah warga yang berdomisili di wilayah kami, tinggal di rumah Bapak/Ibu {{ ucfirst($tinggal) }}. Surat keterangan domisili ini dibuat untuk keperluan {{ strtolower($keperluan) }}</p>
