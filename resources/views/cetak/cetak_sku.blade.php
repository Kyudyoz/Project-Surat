    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h4 style="text-decoration: underline" class="fs-2 mt-4">Surat Keterangan Usaha</h4>
            </div>
        </div>
        <div class="row">
        ...
        <div class="keterangan">      
            <p class="mt-4">Orang tersebut bener-bener memiliki usaha {{ strtolower($usaha) }} bernama {{ strtoupper($nama_usaha) }}</p>
            <p>Demikian surat keterangan usaha ini kami buat dengan sebenarnya untuk dipergunakan sebagaimana mestinya.</p>
        </div>
        <div class="container1" style="margin-top: 10%">
            <div class="row justify-content-center align-items-center">
                <div class="col-md-6">
                    ...
                    <p style="text-align: center">Pemilik Usaha</p>
